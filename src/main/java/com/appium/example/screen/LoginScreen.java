...
public class LoginScreen extends BaseScreen {
    ...
    private void inputEmailAddress(String emailAddress) {
        inputText(AppiumBy.xpath("//XCUIElementTypeTextField[@name=\"Email\"]"), emailAddress);
    }

    private void inputPassword(String password) {
        inputText(AppiumBy.xpath("//XCUIElementTypeSecureTextField[@name=\"Password\"]"), password);
    }
    ...
    private void tapOnLoginButton() {
        tap(AppiumBy.accessibilityId("LOG IN"));
    }
